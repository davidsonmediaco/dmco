...
const getCategoryHeroImage = (category: string): string => {
  switch(category) {
    case 'portraits':
      return "https://images.unsplash.com/photo-1610652492500-ded49ceeb378?q=80&w=1974&auto=format&fit=crop";
    case 'brands':
    ...
    case 'dogs':
      return "https://images.unsplash.com/photo-1541364983171-a8ba01e95cfc?q=80&w=1374&auto=format&fit=crop";
    case 'sports':
