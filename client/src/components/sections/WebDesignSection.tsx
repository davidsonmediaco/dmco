        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-400 mb-8">
              I create custom websites that not only look stunning but also drive real business results. From personal portfolios to small business websites, I handle everything from design to deployment.
            </p>
